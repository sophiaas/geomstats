...
from geomstats.geometry.complex_lie_algebra import ComplexMatrixLieAlgebra
...
class ComplexSquareMatrices(ComplexMatrixLieAlgebra):
    """Lie algebra of the complex general linear group.
    ...
    def __init__(self, n):
        ...
        self._mat_space = ComplexMatrices(n, n)
